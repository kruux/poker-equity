// use crate::{cards::Card, game::GameState, variants::DeuceSeven};
...
//     let mut game = GameState::new(DeuceSeven, 2, players);
...
//     //
//     let playername = "Hero";
//     let mut game = GameState::new(DeuceSeven, 1, vec![playername]);
